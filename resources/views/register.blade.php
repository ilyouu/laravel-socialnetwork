                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-1">
                                    <div class="text-center">
                                        ...
                                        <img src="{{ URL('imagesWebsite/register.png') }}" class="img-fluid" alt="Sample image">
                                        <a class="mt-1 mb-2 pb-1 text-black" href="/">Tạo tài khoản và bắt đầu kết nối với mọi người</a>
                                    </div>
                                </div>

                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-2">
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-1">Đăng ký tài khoản</p>

                                    <form class="mx-1 mx-md-4" method="POST" action="{{ route('storeReg') }}">
                                        @csrf
                                        ...
                                        <div class="d-flex justify-content-center mx mt-4 mb-lg-4">
